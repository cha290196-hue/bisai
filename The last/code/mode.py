...
class FlowerClassifier(nn.Module):
    ...
    参数:
        ...
        model_name: 预训练模型名称 (默认efficientnet_b4)
        pretrained: 是否使用预训练权重 (默认True)
        dropout: Dropout比率 (默认0.5)
    """
    
    def __init__(self, num_classes=100, model_name='efficientnet_b4', 
...
MODEL_CONFIGS = {
    ...
    'swin_base_patch4_window7_224': {
        ...
        'batch_size': 32,
        'params': '88M',
        'description': 'Vision Transformer，基于注意力机制'
    },
    'resnet50': {
        'model_name': 'resnet50',
        'image_size': 224,
...
if __name__ == '__main__':
    # 创建模型
    print("测试模型创建...")
    model = FlowerClassifier(num_classes=100, model_name='efficientnet_b4')
